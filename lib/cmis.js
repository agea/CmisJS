        ...
        function CmisRequest(req, text){
            ...
            */
            this.$ok = function (scope, callback) {
                if (callback){
                    callback_ok = function(){scope.$apply(callback)};
                } else {
                    callback_ok = _noop;
                }
                return this;
            ...
            */
            this.$notOk = function (scope, callback) {
                if (callback){
                    callback_notOk = function(){scope.$apply(callback)};
                } else {
                    callback_notOk = _noop;
                }
            };
            ...
            */
            this.$error = function (scope, callback) {
                if (callback){
                    callback_error = function(){scope.$apply(callback)};
                } else {
                    callback_error = _noop;
                }
                return this;
            };
